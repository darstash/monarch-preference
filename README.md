...
# Introduction
This repository contains R scripts that clean, analyze, and create figures for the manuscript "Monarch caterpillars do not prefer or avoid a common insecticide regardless of experience" submitted to Agricultural and Forest Entomology. We fed monarch larvae either control or clothianidin-treatment milkweed as their intial diet and then performed a two-choice assay.
